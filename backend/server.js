...
const dbUrl = `mongodb+srv://BArthur1972:d5GHuV9rtNRkwsTD@atlascluster.bqqnv3b.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('You are lucky!! server is running...');
});
